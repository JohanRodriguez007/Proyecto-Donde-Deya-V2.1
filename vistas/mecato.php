...
$sql = "SELECT producto_codigo, producto_nombre, producto_precio, producto_stock, producto_foto, producto_id FROM producto WHERE categoria_id = 4";
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <input type="hidden" name="vista_actual" value="mecato">
